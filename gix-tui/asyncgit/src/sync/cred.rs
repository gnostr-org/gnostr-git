...
use super::{remotes::get_default_remote_in_repo, repository::repo, RepoPath};
...
mod tests {
    ...
    use crate::sync::{
        cred::{extract_cred_from_url, extract_username_password, need_username_password, BasicAuthCredential},
    ...
    fn test_credential_complete() {
        assert_eq!(
            BasicAuthCredential::new(Some("username".to_owned()), Some("password".to_owned())).is_complete(),
            true
        );
    }
    ...
    fn test_need_username_password_if_https() {
        ...
        repo.remote(DEFAULT_REMOTE_NAME, "http://user@github.com").unwrap();
    ...
    fn test_dont_need_username_password_if_ssh() {
        ...
        repo.remote(DEFAULT_REMOTE_NAME, "git@github.com:user/repo").unwrap();
    ...
    fn test_extract_username_password_from_repo() {
        ...
        repo.remote(DEFAULT_REMOTE_NAME, "http://user:pass@github.com").unwrap();
