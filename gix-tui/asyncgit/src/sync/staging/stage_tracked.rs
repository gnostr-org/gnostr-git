...
use crate::{
    error::{Error, Result},
    sync::{diff::DiffLinePosition, patches::get_file_diff_patch_and_hunklines, repository::repo, RepoPath},
};

///
pub fn stage_lines(repo_path: &RepoPath, file_path: &str, is_stage: bool, lines: &[DiffLinePosition]) -> Result<()> {
