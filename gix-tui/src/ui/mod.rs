...
pub const fn calc_scroll_top(current_top: usize, height_in_lines: usize, selection: usize) -> usize {
...
///
pub fn common_nav(key: &crossterm::event::KeyEvent, key_config: &SharedKeyConfig) -> Option<MoveSelection> {
