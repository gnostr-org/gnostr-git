...
pub fn tab_status(key_config: &SharedKeyConfig) -> String {
    format!("Status [{}]", key_config.get_hint(key_config.keys.tab_status))
}
...
pub fn tab_stashing(key_config: &SharedKeyConfig) -> String {
    format!("Stashing [{}]", key_config.get_hint(key_config.keys.tab_stashing))
}
pub fn tab_stashes(key_config: &SharedKeyConfig) -> String {
    format!("Stashes [{}]", key_config.get_hint(key_config.keys.tab_stashes))
}
...
pub mod commands {
    ...
    pub fn find_branch(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Find [{}]", key_config.get_hint(key_config.keys.branch_find)),
            "find branch in list",
            CMD_GROUP_GENERAL,
        )
    }
    ...
    pub fn options_popup(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Options [{}]", key_config.get_hint(key_config.keys.open_options),),
            "open options popup",
            CMD_GROUP_GENERAL,
        )
    }
    ...
    pub fn show_tag_annotation(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Annotation [{}]", key_config.get_hint(key_config.keys.move_right),),
            "show tag annotation",
            CMD_GROUP_LOG,
        )
    }
    pub fn diff_hunk_next(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Next hunk [{}]", key_config.get_hint(key_config.keys.diff_hunk_next),),
    ...
    pub fn diff_hunk_prev(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Prev hunk [{}]", key_config.get_hint(key_config.keys.diff_hunk_prev),),
    ...
    pub fn diff_hunk_add(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Add hunk [{}]", key_config.get_hint(key_config.keys.stage_unstage_item),),
    ...
    pub fn close_popup(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Close [{}]", key_config.get_hint(key_config.keys.exit_popup),),
    ...
    pub fn abort_merge(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Abort merge [{}]", key_config.get_hint(key_config.keys.abort_merge),),
            "abort ongoing merge",
            CMD_GROUP_GENERAL,
        )
    }
    ...
    pub fn abort_revert(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Abort revert [{}]", key_config.get_hint(key_config.keys.abort_merge),),
    ...
    pub fn view_submodules(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Submodules [{}]", key_config.get_hint(key_config.keys.view_submodules),),
            "open submodule view",
            CMD_GROUP_GENERAL,
        )
    }
    ...
    pub fn update_submodule(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Update [{}]", key_config.get_hint(key_config.keys.update_submodule),),
            "update submodule",
            CMD_GROUP_GENERAL,
        )
    }
    ...
    pub fn abort_rebase(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Abort rebase [{}]", key_config.get_hint(key_config.keys.abort_merge),),
    ...
    pub fn select_staging(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("To stage [{}]", key_config.get_hint(key_config.keys.toggle_workarea),),
    ...
    pub fn select_unstaged(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("To unstaged [{}]", key_config.get_hint(key_config.keys.toggle_workarea),),
    ...
    pub fn undo_commit(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Undo Commit [{}]", key_config.get_hint(key_config.keys.undo_commit),),
            "undo last commit",
            CMD_GROUP_GENERAL,
        )
    }
    pub fn commit_open(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Commit [{}]", key_config.get_hint(key_config.keys.open_commit),),
    ...
    pub fn commit_enter(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Commit [{}]", key_config.get_hint(key_config.keys.enter),),
    ...
    pub fn commit_amend(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Amend [{}]", key_config.get_hint(key_config.keys.commit_amend),),
    ...
    pub fn commit_signoff(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Sign-off [{}]", key_config.get_hint(key_config.keys.toggle_signoff),),
    ...
    pub fn stage_item(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Stage [{}]", key_config.get_hint(key_config.keys.stage_unstage_item),),
    ...
    pub fn stage_all(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Stage All [{}]", key_config.get_hint(key_config.keys.status_stage_all),),
    ...
    pub fn unstage_item(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Unstage [{}]", key_config.get_hint(key_config.keys.stage_unstage_item),),
    ...
    pub fn reset_item(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Reset [{}]", key_config.get_hint(key_config.keys.status_reset_item),),
    ...
    pub fn ignore_item(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Ignore [{}]", key_config.get_hint(key_config.keys.status_ignore_file),),
    ...
    pub fn stashing_save(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Save [{}]", key_config.get_hint(key_config.keys.stashing_save),),
    ...
    pub fn stashlist_apply(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Apply [{}]", key_config.get_hint(key_config.keys.stash_apply),),
    ...
    pub fn stashlist_inspect(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Inspect [{}]", key_config.get_hint(key_config.keys.stash_open),),
    ...
    pub fn commit_details_open(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Inspect [{}]", key_config.get_hint(key_config.keys.move_right),),
    ...
    pub fn open_file_history(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("History [{}]", key_config.get_hint(key_config.keys.file_history),),
    ...
    pub fn log_tag_commit(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Tag [{}]", key_config.get_hint(key_config.keys.log_tag_commit),),
            "tag commit",
            CMD_GROUP_LOG,
        )
    }
    ...
    pub fn inspect_file_tree(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Files [{}]", key_config.get_hint(key_config.keys.open_file_tree),),
    ...
    pub fn revert_commit(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Revert [{}]", key_config.get_hint(key_config.keys.status_reset_item),),
            "revert commit",
            CMD_GROUP_LOG,
        )
    }
    pub fn log_reset_commit(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Reset [{}]", key_config.get_hint(key_config.keys.log_reset_comit),),
            "reset to commit",
            CMD_GROUP_LOG,
        )
    }
    pub fn log_reword_commit(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Reword [{}]", key_config.get_hint(key_config.keys.log_reword_comit),),
    ...
    pub fn log_close_search(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Exit Search [{}]", key_config.get_hint(key_config.keys.exit_popup),),
            "leave search mode",
            CMD_GROUP_LOG,
        )
    }
    ...
    pub fn tag_commit_confirm_msg(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Tag [{}]", key_config.get_hint(key_config.keys.enter),),
            "tag commit",
            CMD_GROUP_LOG,
        )
    }
    ...
    pub fn tag_annotate_msg(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Annotate [{}]", key_config.get_hint(key_config.keys.tag_annotate),),
            "annotate tag",
            CMD_GROUP_LOG,
        )
    }
    ...
    pub fn create_branch_confirm_msg(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Create Branch [{}]", key_config.get_hint(key_config.keys.enter),),
            "create branch",
            CMD_GROUP_BRANCHES,
        )
        .hide_help()
    ...
    pub fn open_branch_create_popup(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Create [{}]", key_config.get_hint(key_config.keys.create_branch),),
    ...
    pub fn rename_branch_confirm_msg(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Rename Branch [{}]", key_config.get_hint(key_config.keys.enter),),
            "rename branch",
            CMD_GROUP_BRANCHES,
        )
        .hide_help()
    ...
    pub fn rename_branch_popup(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Rename Branch [{}]", key_config.get_hint(key_config.keys.rename_branch),),
            "rename branch",
            CMD_GROUP_BRANCHES,
        )
    }
    pub fn delete_branch_popup(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Delete [{}]", key_config.get_hint(key_config.keys.delete_branch),),
            "delete a branch",
            CMD_GROUP_BRANCHES,
        )
    }
    pub fn merge_branch_popup(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Merge [{}]", key_config.get_hint(key_config.keys.merge_branch),),
            "merge a branch",
            CMD_GROUP_BRANCHES,
        )
    }
    ...
    pub fn branch_popup_rebase(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Rebase [{}]", key_config.get_hint(key_config.keys.rebase_branch),),
            "rebase a branch",
            CMD_GROUP_BRANCHES,
        )
    }
    ...
    pub fn compare_with_head(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Compare [{}]", key_config.get_hint(key_config.keys.compare_commits),),
            "compare with head",
            CMD_GROUP_BRANCHES,
        )
    }
    ...
    pub fn open_branch_select_popup(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Branches [{}]", key_config.get_hint(key_config.keys.select_branch),),
            "open branch popup",
            CMD_GROUP_BRANCHES,
        )
    }
    ...
    pub fn delete_tag_popup(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Delete [{}]", key_config.get_hint(key_config.keys.delete_tag),),
            "delete a tag",
            CMD_GROUP_GENERAL,
        )
    }
    pub fn select_tag(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Select commit [{}]", key_config.get_hint(key_config.keys.select_tag),),
    ...
    pub fn status_force_push(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Force Push [{}]", key_config.get_hint(key_config.keys.force_push),),
    ...
    pub fn find_commit_sha(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Search Hash [{}]", key_config.get_hint(key_config.keys.find_commit_sha),),
