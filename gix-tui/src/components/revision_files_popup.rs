...
use ratatui::{backend::Backend, layout::Rect, widgets::Clear, Frame};

use super::{
    revision_files::RevisionFilesComponent, visibility_blocking, CommandBlocking, CommandInfo, Component,
...
impl RevisionFilesPopup {
    ...
    pub fn new(
        ...
        Self {
            files: RevisionFilesComponent::new(repo, queue, sender, sender_git, theme, key_config.clone()),
            visible: false,
            key_config,
            open_request: None,
            queue: queue.clone(),
