...
use crate::{
    accessors,
    components::{
        command_pump, event_pump, visibility_blocking, CommandBlocking, CommandInfo, Component, DrawableComponent,
...
impl Stashing {
    ...
    pub fn new(
        ...
        Self {
            ...
            theme,
            git_status: AsyncStatus::new(repo.borrow().clone(), sender.clone()),
            queue: queue.clone(),
            key_config,
        }
    }
    ...
    fn get_option_text(&self) -> Vec<Line> {
        ...
        vec![
            ...
            Line::from(vec![
                bracket_open,
                if self.options.keep_index { option_on } else { option_off },
                bracket_close,
